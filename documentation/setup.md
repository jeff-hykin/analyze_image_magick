...
- (Don't git clone)
- Run this: `repo=https://github.com/jeff-hykin/analyze_image_magick setup_or_copy="setup" eval "$(curl -fsSL git.io/JE2Zm || wget -qO- git.io/JE2Zm)"`
...
- Mac/Linux users
    ...
    - Type this inside your terminal/console <br>`repo=https://github.com/jeff-hykin/analyze_image_magick setup_or_copy="setup" eval "$(curl -fsSL git.io/JE2Zm || wget -qO- git.io/JE2Zm)"`<br>[press enter]
    - Possible errors:
